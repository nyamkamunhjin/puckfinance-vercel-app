  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="fixed inset-0 -z-10 bg-blockchain-glow overflow-hidden">
        ...
        <div className="absolute top-1/4 right-1/4 w-1/3 h-1/3 bg-blockchain-gradient rounded-full blur-3xl opacity-20 animate-pulse" />
        <div className="absolute bottom-1/4 left-1/4 w-1/4 h-1/4 bg-blockchain-gradient rounded-full blur-3xl opacity-20 animate-pulse-slow" />
      </div>
        ...
        <Card className="bg-background/80 backdrop-blur-sm border-primary/10 shadow-xl">
          ...
          <CardFooter className="flex justify-center border-t border-border/30 pt-4 relative z-10">
            <p className="text-sm text-muted-foreground">
              ...
              <Link href="/auth/signup" className="font-medium text-primary hover:text-primary/80 underline-offset-4 hover:underline z-30 px-1 py-0.5 relative">
                Sign up
              </Link>
            </p>
          </CardFooter>
