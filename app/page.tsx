                ...
                <main className="flex-1">
                    ...
                    <div className="relative overflow-hidden bg-gradient-to-b from-background to-background/90 pb-16 bg-blockchain-glow bg-hero-glow">
                        ...
                        <div className="container mx-auto px-4 pt-20 pb-16 text-center lg:pt-32 relative z-10">
                            ...
                            <div
                                className="absolute bottom-0 left-0 w-1/4 h-1/4 bg-blockchain-gradient rounded-full blur-3xl opacity-50 animate-pulse z-0"
                            ...
                            <p className="mx-auto mt-6 max-w-2xl text-xl text-muted-foreground relative z-10">
                                Connect TradingView strategies to exchanges,
                                manage your portfolio, and track performance in
                            ...
                            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center relative z-10">
                                <Button
                                    asChild
                                    size="lg"
                                    className="text-base px-8 relative overflow-hidden bg-primary hover:bg-primary/90 bg-shimmer"
                                >
                                    <Link
                                ...
                                <Button
                                    ...
                                    size="lg"
                                    asChild
                                    className="text-base px-8 backdrop-blur-sm bg-background/50 border-primary/20"
                                >
                                ...
                                <div className="relative mx-auto max-w-5xl rounded-xl border border-primary/10 shadow-2xl bg-background/50 backdrop-blur-sm overflow-hidden">
                                    ...
                                    <div className="py-16 px-8 flex flex-col items-center justify-center relative z-10">
                                        ...
                                        <h2 className="text-2xl font-bold text-center mb-2">
                                            Power Your Trading with Automation
                                        </h2>
                                        <p className="text-center text-muted-foreground max-w-lg mb-6">
                                            Connect TradingView alerts to your
                                            exchange accounts and let your
                                            strategies work for you 24/7.
                                        </p>
                    ...
                    <section className="py-20 bg-muted/30 relative overflow-hidden">
                        ...
                        <div
                            className="pulse-point pulse-point-2"
                            style={{ zIndex: 1, animationDelay: '2.5s' }}
                        />
                        <div
                            className="pulse-point pulse-point-3"
                            style={{ zIndex: 1, animationDelay: '0.8s' }}
                        />
                        <div className="container mx-auto px-4 relative z-10">
                            <div className="text-center mb-16">
                                ...
                                <p className="mt-4 text-xl text-muted-foreground max-w-3xl mx-auto">
                                    Simplify your trading workflow and maximize
                                    performance with our comprehensive platform
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                <Card className="bg-background/60 backdrop-blur-sm border-primary/10 hover:shadow-md hover:border-primary/20 transition-all relative overflow-hidden group">
                                    ...
                                    <CardContent className="relative z-10">
                                        <p className="text-muted-foreground">
                                            Seamlessly connect your TradingView
                                            strategies directly to Binance,
                                            Bybit, and more exchanges coming
                                            soon.
                                        </p>
                                    </CardContent>
                                </Card>
                                ...
                                <Card className="bg-background/60 backdrop-blur-sm border-primary/10 hover:shadow-md hover:border-primary/20 transition-all relative overflow-hidden group">
                                        ...
                                        <div className="w-12 h-12 rounded-lg bg-purple-500/10 flex items-center justify-center mb-4">
                                            ...
                                            >
                                                <path
                                                    ...
                                                    strokeLinejoin="round"
                                                    strokeWidth={2}
                                                    d="M7 12l3-3m0 0l3 3m-3-3v12m6-9l3 3m0 0l3-3m-3 3V6"
                                                />
                                            </svg>
                                        </div>
                                        <CardTitle>
                                    ...
                                    <CardContent className="relative z-10">
                                        <p className="text-muted-foreground">
                                            Single source crypto trading
                                            portfolio managing with
                                ...
                                <Card className="bg-background/60 backdrop-blur-sm border-primary/10 hover:shadow-md hover:border-primary/20 transition-all relative overflow-hidden group">
                                    ...
                                    <CardContent className="relative z-10">
                                        <p className="text-muted-foreground">
                                            ...
                                            simultaneously and monitor their
                                ...
                                <Card className="bg-background/60 backdrop-blur-sm border-primary/10 hover:shadow-md hover:border-primary/20 transition-all relative overflow-hidden group">
                                    ...
                                    <CardContent className="relative z-10">
                                        <p className="text-muted-foreground">
                                            Analyze TradingView strategies
                                            performance with detailed metrics
                                            and insights to optimize your
                                            trading.
                                        </p>
                                    </CardContent>
                                </Card>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                <div className="text-center bg-background/40 backdrop-blur-sm p-8 rounded-xl border border-primary/5 relative overflow-hidden group hover:border-primary/10 transition-all">
                                    ...
                                    <p className="text-muted-foreground relative z-10">
                                        Securely link your Binance, Bybit, or
                                        other exchange accounts using API keys.
                                    </p>
                                </div>
                                ...
                                <div className="text-center bg-background/40 backdrop-blur-sm p-8 rounded-xl border border-primary/5 relative overflow-hidden group hover:border-primary/10 transition-all">
                                    ...
                                    <p className="text-muted-foreground relative z-10">
                                        Configure your TradingView strategies to
                                        execute automatically on your connected
                                        exchanges.
                                    </p>
                                </div>
                                ...
                                <div className="text-center bg-background/40 backdrop-blur-sm p-8 rounded-xl border border-primary/5 relative overflow-hidden group hover:border-primary/10 transition-all">
                                    ...
                                    <p className="text-muted-foreground relative z-10">
                                        Monitor results, analyze performance,
                                        and optimize your strategies for better
                                        returns.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="container mx-auto px-4 text-center relative z-10">
                            <div className="max-w-3xl mx-auto bg-background/40 backdrop-blur-md p-12 rounded-2xl border border-primary/10 relative overflow-hidden">
                                ...
                                <p className="text-xl text-muted-foreground mx-auto mb-10 relative z-10">
                                    Join thousands of traders already using our
                                    platform to automate and optimize their
                ...
                <div className="grid gap-6">
                        ...
                        <CardHeader>
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <CardDescription>
                                        Here's an overview of your trading
                                        activity
                                    </CardDescription>
                                </div>
                            </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <Card className="hover:shadow-md transition-shadow">
                            ...
                            <CardContent>
                                <p className="text-sm text-muted-foreground">
                                    Connect to exchanges and manage your trading
                        ...
                        <Card className="hover:shadow-md transition-shadow">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    View your recent trading activity
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <p className="text-sm text-muted-foreground">
                                    Track your trade history, performance
                                    metrics, and open positions.
                                </p>
                            </CardContent>
                            <CardFooter>
                                <Button
                        ...
                        <Card className="hover:shadow-md transition-shadow">
                            ...
                            <CardContent>
                                <p className="text-sm text-muted-foreground">
                                    Customize your profile, notification
